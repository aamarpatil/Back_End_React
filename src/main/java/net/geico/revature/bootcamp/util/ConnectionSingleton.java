package net.geico.revature.bootcamp.util;
...
public class ConnectionSingleton {
    ...
    public static Connection getConnection() {
        ...
        System.out.println("In the ConnectionSingleton getConnection() Method");

        if (connection == null) {
            try {
                connection = DriverManager.getConnection(url, username, password);
                System.out.println("Calling ConnectionSingleton resetTestDatabase() Method");
                resetTestDatabase();
...
//        if there is no connection, use the getConnection method to set it up
        ...
        System.out.println("In the ConnectionSingleton resetTestDatabase() Method");
...
//            otherwise, recreate the tables without setting up a new connection
            try {
                System.out.println("Running Tables.sql file to Drop & Create tables");
                FileReader sqlReader = new FileReader("backend/src/main/resources/tables.sql");
